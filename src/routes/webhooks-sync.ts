...
export class WebhookSyncPaymentRoutes {
    public static routes(app: Application) {
        app.post("/webhooks-sync/payment", validator.body(validatePaymentEvent), async (req, res) => {
            try {
...
export default new  WebhookSyncPaymentRoutes();
